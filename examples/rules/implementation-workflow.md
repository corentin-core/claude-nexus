...
- Check linter/formatter config files (`pyproject.toml`, `.eslintrc`, `Cargo.toml`, etc.)
- Check CI config (`.github/workflows/`, `.gitlab-ci.yml`)
- Check dependency/build config
...
- Add the design to the issue body or as a comment
